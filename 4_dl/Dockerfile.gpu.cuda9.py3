...
FROM global/cuda_py:${CUDA_VERSION}py3
...
# Install TensorFlow
# RUN ${PYTHON} -m pip --no-cache-dir install https://storage.googleapis.com/tensorflow/linux/${TENSORFLOW_ARCH}/tensorflow_${TENSORFLOW_ARCH}-${TENSORFLOW_VERSION}-cp${PYTHON_VERSION}-cp${PYTHON_VERSION}m-linux_x86_64.whl
